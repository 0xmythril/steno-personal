...
// inline so no request leaves the box for them, and drawn in currentColor.
...
function GitHubMark() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" aria-hidden focusable="false" fill="currentColor">
...
function XMark() {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" aria-hidden focusable="false" fill="currentColor">
